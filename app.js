...
const prompts = [
  { key: "rocket", title: "Space Rocket", hint: "3, 2, 1 — I leave the planet on a pillar of fire" },
  { key: "octopus", title: "Giant Octopus", hint: "Eight arms, three hearts, and way too smart for the ocean" },
  { key: "pizza", title: "Pizza Slice", hint: "Born round, boxed square, eaten as a triangle" },
  { key: "dragon", title: "Fire Dragon", hint: "I breathe fire but I'm not a volcano, I fly but I'm not a bird" },
  { key: "penguin", title: "Emperor Penguin", hint: "I wear a tuxedo every day but I've never been to a party" },
  { key: "ufo", title: "Alien UFO", hint: "Nobody believes you saw me, but check the sky at midnight" },
  { key: "skull", title: "Pirate Skull", hint: "I'm the face under your face, and I'm always grinning" },
  { key: "palmtree", title: "Coconut Palm", hint: "I stand on one leg with a wild green hairdo and coconuts" },
  { key: "robot", title: "Dancing Robot", hint: "Metal brain, pixel eyes, and programmed to boogie" },
  { key: "flamingo", title: "Pink Flamingo", hint: "I'm pink because of my diet and I sleep on one leg" },
  { key: "volcano", title: "Active Volcano", hint: "I'm a mountain with anger issues and a lava lamp inside" },
  { key: "sword", title: "Knight Sword", hint: "Knights carried me, pirates swung me, Jedi upgraded me" },
  { key: "mushroom", title: "Magic Mushroom", hint: "I pop up after rain — some feed you, some send you places" },
  { key: "icecream", title: "Ice Cream Cone", hint: "I'm cold, I'm sweet, and I'm always having a meltdown" },
  { key: "castle", title: "Medieval Castle", hint: "Drawbridge, dungeon, and a dragon problem upstairs" },
  { key: "cat", title: "Sneaky Cat", hint: "I knock things off tables for sport and judge you silently" },
  { key: "anchor", title: "Ship Anchor", hint: "I hold giants still but I live at the bottom of the sea" },
  { key: "lightning", title: "Lightning Bolt", hint: "I'm gone before you hear me and I never strike twice, they say" },
  { key: "crown", title: "Royal Crown", hint: "I sit on heads but I'm not a hat, I make you royalty" },
  { key: "ghost", title: "Spooky Ghost", hint: "I walk through walls, rattle chains, and say BOO a lot" },
  { key: "hotdog", title: "Street Hot Dog", hint: "I'm a sausage in a sleeping bag at every baseball game" },
  { key: "dinosaur", title: "Mighty T-Rex", hint: "Tiny arms, big dreams, sixty-five million years ago" },
  { key: "sailboat", title: "Ocean Sailboat", hint: "I catch wind for a living and never need gasoline" },
  { key: "owl", title: "Night Owl", hint: "I spin my head almost all the way around and hunt at midnight" },
  { key: "diamond", title: "Shiny Diamond", hint: "I started as coal, took a billion years, now I'm on a ring" },
  { key: "butterfly", title: "Monarch Butterfly", hint: "I was a caterpillar once, now I paint the sky" },
  { key: "guitar", title: "Rock Guitar", hint: "Six strings, one hole, infinite songs — strum me" },
  { key: "jellyfish", title: "Neon Jellyfish", hint: "No brain, no heart, no blood — but I can still sting you" },
  { key: "sunflower", title: "Giant Sunflower", hint: "I follow the sun all day and my face is full of seeds" },
  { key: "pirateship", title: "Pirate Ship", hint: "Skull flag, wooden plank, and stolen treasure below deck" },
];
